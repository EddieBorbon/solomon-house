 ...
 */
export class FeedbackDelayFactory implements IEffectFactory {
  ...
  createEffect(): EffectNode {
    const effectNode = new Tone.FeedbackDelay({
      delayTime: '8n',    // Tiempo de delay en notas musicales
      feedback: 0.3,      // Feedback moderado para evitar oscilación
      wet: 0.5           // Mezcla entre señal seca y procesada
    });

    console.log(`🎛️ FeedbackDelayFactory: FeedbackDelay creado con parámetros iniciales:`, {
